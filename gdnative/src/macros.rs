...
#[macro_export]
macro_rules! godot_create_constructor {
    ($_name:ty, $c:expr) => {
        {
            unsafe extern "C" fn constructor(
                ...
                let val = $c($crate::GodotClassInfo{ this: this });
...
#[macro_export]
macro_rules! godot_create_destructor {
    ($name:ty) => {
        {
...
#[macro_export]
macro_rules! godot_create_method_parameter_count {
    () => {
        0
    };
    ($name:ident, $($other:ident,)*) => {
        1 + godot_create_method_parameter_count!($($other,)*)
    }
}

#[macro_export]
macro_rules! godot_create_method {
    (
        $type_name:ty,
    ...
    ) => {
        {
            unsafe extern "C" fn method(
                ...
                let num_params = godot_create_method_parameter_count!($($pname,)*);
