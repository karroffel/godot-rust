...
pub type GodotScriptMethodType = unsafe extern "C" fn(
...
pub type GodotScriptConstructorType = unsafe extern "C" fn(
    *mut sys::godot_object,
    *mut libc::c_void
) -> *mut libc::c_void;

pub type GodotScriptDestructorType = unsafe extern "C" fn(
    *mut sys::godot_object,
    *mut libc::c_void,
    *mut libc::c_void
) -> ();
...
pub struct GodotScriptMethod<'l> {
    pub name: &'l str,
    pub method_ptr: Option<GodotScriptMethodType>,
...
pub struct GodotScriptClassBuilder<'l> {
    ...
    constructor: Option<GodotScriptConstructorType>,
    destructor: Option<GodotScriptDestructorType>,
...
impl<'l> GodotScriptClassBuilder<'l> {
    ...
    pub fn add_method(mut self, name: &'l str, method: GodotScriptMethodType) -> Self {
    ...
    pub fn set_constructor(mut self, constructor: Option<GodotScriptConstructorType>) -> Self {
        self.constructor = constructor;
        self
    }

    pub fn set_destructor(mut self, destructor: Option<GodotScriptDestructorType>) -> Self {
