...
impl Vector2Array {
    ...
    pub fn push(&mut self, vector: Vector2) {
        unsafe {
            (get_api().godot_pool_vector2_array_append)(
                &mut self.0,
                &vector as *const _ as *const sys::godot_vector2,
            );
        }
    }
    ...
    pub fn push_array(&mut self, vectors: &Vector2Array) {
        unsafe {
            (get_api().godot_pool_vector2_array_append_array)(&mut self.0, vectors.sys());
        }
    }
    ...
    pub fn insert(&mut self, offset: i32, vector: Vector2) -> bool {
        unsafe {
            let status = (get_api().godot_pool_vector2_array_insert)(
                &mut self.0,
                offset,
                &vector as *const _ as *const sys::godot_vector2,
            );
    ...
    pub fn set(&mut self, idx: i32, vector: Vector2) {
        unsafe {
            (get_api().godot_pool_vector2_array_set)(
                &mut self.0,
                idx,
                &vector as *const _ as *const sys::godot_vector2,
            );
